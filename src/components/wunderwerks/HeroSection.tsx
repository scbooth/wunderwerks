...
import { ArrowDownRight, Beer, Droplets, Factory } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen scroll-mt-24 overflow-hidden bg-charcoal text-sand"
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 pb-28 pt-32 lg:grid-cols-2 lg:items-center lg:px-16 lg:pb-32 lg:pt-36">
        ...
        >
          <p className="mb-4 text-xs uppercase tracking-[0.35em] text-brass">
