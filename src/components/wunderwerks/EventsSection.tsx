    ...
    <SectionShell id="events" className="relative bg-sand">
      {isProhibition ? (
        <div className="mx-auto flex min-h-[240px] max-w-7xl items-center justify-center px-6 text-center">
          <p className="font-display text-3xl font-semibold text-charcoal/70 md:text-4xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {events.map((event, index) => (
            <motion.article
              ...
              className="group rounded-sm border border-charcoal/10 bg-white p-6 shadow-sm transition-shadow hover:border-brass/25 hover:shadow-md"
            >
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-brass/25 bg-brass/8 px-3 py-1 text-label-light">
