...
function FriendsFamilyBeerCard({
  ...
  return (
    <motion.article
      ...
      className="relative flex flex-col rounded-sm border border-dashed border-brass/35 bg-sand/5 p-6"
    >
      <span className="inline-flex w-fit items-center gap-1.5 rounded-full border border-brass/40 bg-brass/10 px-3 py-1 text-[10px] uppercase tracking-[0.18em] text-brass">
        <Users className="h-3 w-3" />
        Friends &amp; Family Series
      </span>

      <h4 className="mt-4 font-[family-name:var(--font-germania)] text-2xl text-cream">
        {beer.name}
      </h4>
